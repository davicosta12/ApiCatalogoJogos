...
namespace ApiCatalogosJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        public async Task<ActionResult<JogoViewModel>> InserirJogo([FromBody] JogoInputModel jogoInputModel)
        {
            ...
            {
                return UnprocessableEntity("Já existe um jogo com este nome para esta produtra");
            }
        }
        ...
        public async Task<ActionResult> AtualizarPreco([FromRoute] Guid idJogo, [FromBody]  double preco)
        {
            try
            {
